...
public class Const {
	...
	public static final String ICONS_LOCATION					= "conf/icons";
	public static final String CONFIG_FRAME_WIDTH				= "sbi.ui.frame.width";
	public static final String CONFIG_FRAME_HEIGHT				= "sbi.ui.frame.height";
